...
public abstract partial class BaseGameView : Node2D
{
	...
	protected virtual void HideCardsAndMarkings()
	{
		foreach (var pile in GetPilesForInput()) pile.Visible = false;
	}

	protected virtual void ShowCardsAndMarkings()
	{
		foreach (var pile in GetPilesForInput()) pile.Visible = true;
	}
